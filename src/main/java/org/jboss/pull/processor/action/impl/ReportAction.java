package org.jboss.pull.processor.action.impl;
...
public class ReportAction implements Action {
	...
	@Override
	public void execute(List<ProcessingResult> data) {
		try {
    ...
    private File generateReport(List<ProcessingResult> data, String fileName) throws IOException, TemplateException, URISyntaxException {
